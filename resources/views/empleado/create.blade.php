...
@section('content')
    ...
    <div class="container">
        ...
        {!! Form::open(['route' => 'empleado.store', 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'empleadoForm']) !!}
        @if ($errors->any())
...
@endif
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    {!! Form::text('nombre', null, ['class' => 'form-control form-control-m', 'required', 'maxlength' => '40', 'pattern' => '^[A-Za-záéíóúÁÉÍÓÚñÑ\s]+$']) !!}
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    {!! Form::label('apellido', 'Apellido') !!}
                    {!! Form::text('apellido', null, ['class' => 'form-control form-control-m', 'required', 'maxlength' => '40', 'pattern' => '^[A-Za-záéíóúÁÉÍÓÚñÑ\s]+$']) !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-8">
            <div class="form-group">
                ...
                {!! Form::email('email', null, ['class' => 'form-control', 'required', 'pattern' => '^[a-z._%+-]+@consultancysc\.com$']) !!}
            </div>
        </div>
        <div class="row">
        <div class="col-sm-6">
    ...
    {!! Form::date('alta', isset($fechaHoy) ? $fechaHoy : null, ['class' => 'form-control', 'required']) !!}
</div>
</div>
<div class="col-sm-6">
    <div class="form-group">
        {!! Form::label('termino', 'Fecha de Término') !!}
        {!! Form::date('termino', $empleado->termino ?? '00-00-0000', ['class' => 'form-control', 'required']) !!}
    </div>
</div>
