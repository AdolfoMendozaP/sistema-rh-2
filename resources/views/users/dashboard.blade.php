...
<body>
    <div class="sidebar">
        ...
        <ul class="menu">
            ...
            <li class="active">
                <a href="{{ url('/registro/empleado') }}"></a>
                <div class="menu-item">
...
<div class="container">
    ...
    <a href="{{ route('users.create') }}" class="btn btn-purple-light float-md-start">Registrar Nuevo Usuario</a>
</div>
        <div class="col-md-6 ms-auto text-md-end">
        <a href="{{ route('empleado.index') }}" class="btn btn-primary">Empleados</a>
        </div>
    </div>
</div>
<br>
